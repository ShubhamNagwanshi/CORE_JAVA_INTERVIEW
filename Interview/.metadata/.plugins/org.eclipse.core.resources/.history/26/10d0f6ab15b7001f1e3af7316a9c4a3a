...
//		System.out.println(list.remove(2));
		System.out.println(list);
		System.out.println(list.set(3, 600));
		System.out.println(list);
		...
		System.out.println(l.peek() + "peekk");
		System.out.println(l);
		...
		System.out.println("--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--Stack--");
