...
public class MultiThreadEchoServer extends Thread {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Echo server start on port 5643");
			...
			while(isRunning) {
				...
				MultiThreadEchoServer echoServer = new MultiThreadEchoServer(clientSocket);
